...
public class PerformanceBuildAction implements Action, StaplerProxy {
    ...
    /**
     * Configured parsers used to parse reports in this build. For compatibility
     * reasons, this can be null.
     */
    ...
    public PerformanceReportMap getPerformanceReportMap() {
        ...
        final WeakReference<PerformanceReportMap> wr = this.performanceReportMap;
        if (wr != null) {
            reportMap = wr.get();
            if (reportMap != null) {
                return reportMap;
